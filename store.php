    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <div class="row mx-2">
                                <form class="form-inline my-2 my-lg-0" method="GET" action="searchmed.php">
            ...
            <body>
                ...
                <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCIsCfjvD2IY2UzqSLJFbv5yoGfSRIXRKg&callback=initMap" async defer></script>
                <!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCIsCfjvD2IY2UzqSLJFbv5yoGfSRIXRKg&callback=initMap" async defer></script> -->
                <!-- products -->
                <br>
                <br>
...
$conn = mysqli_connect($server,$user,$password,$db);
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <img src="https://source.unsplash.com/250x200/?medicine" class="card-img" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title"><a href="product.php?catid='.$id.'">'.$cat.'</a></h5>
                            <p class="card-text">Qty '.$man.'</p>
                            <p class="card-text">Rs. '.$con.'</p>
                            <p class="card-text">Qty '.$quan.'</p>
                            <p class="card-text">Rs. '.$desc.'</p>
                            <a href="product.php?catid='.$id.'" class="btn btn-primary">Substitute</a>
                        </div>
                    </div>
                </div>
            </div>';
